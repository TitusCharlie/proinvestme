									...
									<?php if ($role == ROLE_CLIENT) { ?>
										...
										<li class="dt-side-nav__item <?php if ($this->uri->segment(1) == "deposits") {
											...
											<a href="javascript:void(0)" class="dt-side-nav__link dt-side-nav__arrow" title="Dashboard">
												<i class="icon icon-revenue2 icon-fw icon-lg"></i> <span class="dt-side-nav__text"><?php echo lang("deposits") ?></span> </a>
										...
										<li class="dt-side-nav__item <?php if ($this->uri->segment(1) == "withdrawals") {
											...
											<a href="javascript:void(0)" class="dt-side-nav__link dt-side-nav__arrow" title="Dashboard">
												<i class="icon icon-revenue-new icon-fw icon-lg"></i><span class="dt-side-nav__text"><?php echo lang("withdrawals") ?></span> </a>
									...
									<?php } else { ?>
										...
										<?php if (
											...
											<li class="dt-side-nav__item <?php if ($this->uri->segment(1) == "withdrawals" || $this->uri->segment(1) == "deposits" || $this->uri->segment(1) == "earnings") {
												...
												<a href="javascript:void(0)" class="dt-side-nav__link dt-side-nav__arrow" title="Dashboard">
													<i class="icon icon-revenue-new icon-fw icon-lg"></i><span class="dt-side-nav__text"><?php echo lang("transactions") ?></span> </a>
										...
										<?php if (
											...
											<li class="dt-side-nav__item <?php if ($this->uri->segment(1) == "clients" || $this->uri->segment(1) == "team") {
												...
												<a href="javascript:void(0)" class="dt-side-nav__link dt-side-nav__arrow" title="Dashboard">
													<i class="icon icon-contacts-app icon-fw icon-lg"></i><span class="dt-side-nav__text"><?php echo lang("users") ?></span> </a>
										...
										<li class="dt-side-nav__item" <?php if ($this->uri->segment(1) == "webcontrol") {
											...
											<a href="<?php echo base_url(); ?>webcontrol/templates" class="dt-side-nav__link <?php if ($this->uri->segment(1) == "webcontrol") {
																																	echo "active";
																																} ?>" title="Web Control">
										...
										<?php if (
											...
											<li class="dt-side-nav__item <?php if ($this->uri->segment(1) == "settings") {
												...
												<a href="javascript:void(0)" class="dt-side-nav__link dt-side-nav__arrow" title="Dashboard">
													<i class="icon icon-settings icon-fw icon-lg"></i><span class="dt-side-nav__text"><?php echo lang("settings") ?></span> </a>
												<!-- Sub-menu -->
