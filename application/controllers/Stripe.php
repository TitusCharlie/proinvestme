    ...
    */
    public function stripePost()
    {
        ...
        if ($success!=1)
        {
            ...
            //Add the deposit
            $result = $this->transactions_model->addNewDeposit($this->vendorId, $depositInfo, $earningsAmount, $startDate, $endDate, $payoutsInterval, $maturityPeriod, $businessDays, $planInfo->principalReturn);
