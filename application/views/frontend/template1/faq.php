        ...
        <div class="container">
            <div class="section-heading text-center">
                ...
                <div class="dream-dots justify-content-center fadeInUp" data-wow-delay="0.2s">
                    <span class="gradient-text blue"><?php echo $this->web_model->getTemplateContent('card_4_subtitle', $template)->value; ?></span>
                </div>
                <h2 class="fadeInUp" data-wow-delay="0.3s"><?php echo $this->web_model->getTemplateContent('card_4_title', $template)->value; ?></h2>
            </div>
            <div class="row align-items-center">
