...
<div class="dt-content-wrapper">
    ...
    <div class="dt-page__header">
        <h1 class="dt-page__title" style="display: inline;">Footer Note</h1>
        <button id="editContent" class="btn btn-primary btn-sm display-i ft-right">Save</button>
    </div>
    <!-- /page header -->
    ...
    <div class="row">
        ...
        <div class="col-xl-12">
            ...
            <div class="dt-card">
                ...
                <?php echo form_open(base_url( 'edit_footer' ), array( 'id' => 'policyForm' ));?>
