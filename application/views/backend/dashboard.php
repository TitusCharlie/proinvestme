								...
								<div class="col-md-6">
									...
									<div class="dt-card">
										...
										<div class="dt-card__body p-xl-8 py-sm-8 py-6 px-4 dt-card bg-secondary text-white">
											...
											<!-- Media -->
											<div class="media">
												<i class="icon icon-users text-white icon-5x mr-xl-5 mr-3 align-self-center"></i>
												<!-- Media Body -->
												<div class="flex-1">
								...
								<div class="col-md-6">
									...
									<div class="dt-card">
										...
										<div class="dt-card__body p-xl-8 py-sm-8 py-6 px-4 dt-card bg-primary text-white">
											...
											<!-- Media -->
											<div class="media">
												<i class="icon icon-revenue bg-primary text-white icon-5x mr-xl-5 mr-3 align-self-center"></i>
												<!-- Media Body -->
												<div class="flex-1">
													<div class="d-flex align-items-center mb-2">
